...
import com.hfits.common.utils.http.UserAgentUtils;
import com.hfits.common.utils.ip.AddressUtils;
...
public class AsyncFactory {
     ...
     * API接口统计记录
     *
     * @param record API接口统计记录信息
     * @return 任务task
     */
    public static TimerTask recordApiStatistics(final ApiLog record) {
        return new TimerTask() {
            @Override
            public void run() {
