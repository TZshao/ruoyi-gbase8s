package com.hfits.common.utils.file;

import com.hfits.common.config.HfitsConfig;
import com.hfits.common.constant.Constants;
import com.hfits.common.exception.file.FileNameLengthLimitExceededException;
import com.hfits.common.exception.file.FileSizeLimitExceededException;
import com.hfits.common.exception.file.InvalidExtensionException;
...
import com.hfits.common.utils.uuid.Seq;
...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = HfitsConfig.getProfile();
    ...
    public static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = HfitsConfig.getProfile().length() + 1;
