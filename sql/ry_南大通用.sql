...
create table sys_user (
                          ...
                          login_date        DATETIME YEAR TO SECOND                                   ,
                          pwd_update_date   DATETIME YEAR TO SECOND                                   ,
                          create_by         varchar(64)     default ''                 ,
                          create_time       DATETIME YEAR TO SECOND                                   ,
                          update_by         varchar(64)     default ''                 ,
                          update_time       DATETIME YEAR TO SECOND                    ,
...
(
    post_id       SERIAL8 not null    primary key,
...
create table sys_role (
                          role_id              SERIAL8 not null    primary key,
...
create table sys_menu (
                          menu_id           SERIAL8 not null    primary key,
...
insert into sys_menu values('4', '若依官网', '0', '4', 'http://hfits.vip', null, '', '', 0, 0, 'M', '0', '0', '', 'guide',    'admin', now(), '', null, '若依官网地址');
-- 二级菜单
...
(
    dict_id          SERIAL8 not null  primary key  ,
...
(
    dict_code        SERIAL8 not null   primary key ,
...
create table gen_table (
                           table_id          SERIAL8 not null  primary key  ,
...
create table gen_table_column (
                                  column_id         SERIAL8 not null    primary key,
                                  table_id          bigint                                 ,
