...
import com.hfits.common.utils.FieldTypeUtil;
...
public class DataMigrationService {
    ...
    public ValidationResult validate(MigrationRequest request) {
        ...
        try {
            // 查询部分数据
            Integer limit = request.getValidateLimit();
     ...
     * 将源数据转换为实体类对象
     */
    private Object convertToEntity(Map<String, Object> sourceData, Class<?> entityClass, Map<String, String> fieldMappingMap)
            throws Exception {
        ...
        for (Map.Entry<String, String> entry : fieldMappingMap.entrySet()) {
            ...
            // 类型转换
            Object convertedValue = FieldTypeUtil.convertValue(value, fieldType);
